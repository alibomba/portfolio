...
const DatePicker = () => {
    ...
    const { updateDate } = useContext(ReservationContext);
    ...
    class DatePicker extends HTMLElement {
        ...
        selectDay(el, day) {
            ...
            if (day.monthNumber !== this.calendar.month.number) {
                ...
                this.selectedDayElement.removeAttribute('aria-selected');
        ...
        get style() {
            ...
            .month-day.selected, .month-day.selected:hover {
        ...
        render() {
            ...
            <div aria-label="wybierz datę wizyty" class="calendar-dropdown">
              <div class="header">
